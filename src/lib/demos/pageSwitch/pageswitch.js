...
(function($){
	...
	$.fn.PageSwitch = function(options){
		// 有余初始化的时候使用的是 $("[data-pageSwitch]") ;所以获取的可能是多个对象，因此需要遍历，实现全部实例化
		// 同时，这里使用的是单例模式
		return this.each(function(){
			var me = $(this),
				instance = me.data("PageSwitch");	//获取 data 的 pageSwitch 属性值
			if(!instance){
				me.data("PageSwitch", (instance = new PageSwitch(me, options)));
			}
			if($.type(options) === "string") return instance[options]();
			//例如传入的是一个 init 字符串，那么直接在初始化的时候就执行该类里面的方法。确实很妙
		});
	};
